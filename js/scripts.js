...
function downloadAlbum(albumId) {
	...
	$.ajax({
		url : 'downloadalbum.php?albumid=' + albumId,
		type : 'get',
		success : function(data) {
...
function moveAlbum(albumId) {
	...
	$.ajax({
		url : 'downloadalbum.php?albumid=' + albumId + '&move=true',
		type : 'get',
		success : function(data) {
			location.href = "move.php?albumid=" + albumId;
		},
		error : function(data) {
			alert('Error Occure on server,Please Try again')
		}
...
function moveAllAlbums(albumIds) {
	...
	$("#downloadprogress").show();
	$('#openmodal').click();
	//location.href = "downloadalbum.php?albumids=" + albumIds +"&move=true";
	$.ajax({
		url : 'downloadalbum.php?albumids=' + albumIds + '&move=true',
		type : 'get',
		success : function(data) {
			location.href = "move.php?albumids=" + albumIds;
		},
		error : function(data) {
			//Handle error
			alert('Error Occure on server,Please Try again')
...
function downloadAllAlbums(albumIds) {
	...
	$("#downloadprogress").show();
	$('#openmodal').click();
	//location.href="downloadalbum.php?albumids="+ albumIds;
	$.ajax({
		url : 'downloadalbum.php?albumids=' + albumIds,
		type : 'get',
		success : function(data) {
